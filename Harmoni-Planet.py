...
imagefile_folder = r"D:\Planet_Harmonization\Test_Data_Beijing"
...
edgefile_path = r"E:\Planet_Data\Beijing\Test_Harmonization\edge.csv"        # Path to the edge data file
invarpx_path = r"E:\Planet_Data\Beijing\Test_Harmonization\invar.csv"        # Path to the invariant pixel data file
